...
- [x] **LLM Pricing Analysis (Phase 3.1b)**: Implemented Supabase Edge Function with Gemini API integration, exponential backoff, and daily rate limiting (5/day). Integrated into `AnalyzePriceCard` and `ResultsDisplay` with a rules-based fallback. (Added 2026-01-08)
