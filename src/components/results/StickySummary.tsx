          ...
          {hasVariants ? (
            ...
            <div className="flex gap-md overflow-x-auto no-scrollbar items-center mask-fade-right">
              {results.variantResults?.map((vr) => (
                <div
                  key={vr.id}
                  className="flex flex-col min-w-[100px] gap-0.5 shrink-0 border-r border-border-subtle pr-md last:border-0 last:pr-0"
                >
                  ...
                  <div className="flex items-baseline gap-xs">
                    <span
                      className={`text-sm font-bold tabular-nums ${isStale ? 'text-clay' : 'text-ink-900'}`}
                    >
            ...
            <div className="flex flex-col gap-1.5 w-full">
              <div className="flex items-baseline justify-between w-full text-sm">
                ...
                <div className="flex flex-col items-end">
                  ...
                  <span
                    className={`font-bold tabular-nums text-lg leading-none ${isStale ? 'text-clay animate-pulse' : 'text-ink-900'}`}
                  >
